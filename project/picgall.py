...
def insert():
    ...
    button_dob = Button(ins, text = "очистить", command = clear, font = "georgia 8" )
    ...
    button_q["bg"] = "#948eab"
    button_q["activebackground"] = "#730e1d"
    button_mm = Button(ins, text = "вернуть в главное меню", command = mm, font = "georgia 8" )
    button_mm.place(x = 250, y = 450)
    button_mm["bg"] = "#948eab"
    button_mm["activebackground"] = "#7f7994"
...
button_find = Button(text = "купить картину", command = find, font = "georgia 8")
button_find.place(x = 50, y = 120)
button_find["bg"] = "#948eab"
button_find["activebackground"] = "#7f7994"
button_ins = Button(text = "добавить информацию о художнике и картине", command = insert, font = "georgia 8")
